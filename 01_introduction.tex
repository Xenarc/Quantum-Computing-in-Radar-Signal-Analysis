...
\almarginpar{Should "radar signals" be qualified with "in-phase and quadrature signals"?}\textbf{Research Question: To what extent can quantum computing methods be used to detect, characterise, and identify radar signals?}
