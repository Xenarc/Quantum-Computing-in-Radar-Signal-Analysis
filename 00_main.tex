...
% ----------- To hide all "todo" notes, comment the first line and uncomment the next
...
\begin{acronym}
    ...
    \acro{ECM}{Electronic Counter-Measures}
    \acro{ECCM}{Electronic Counter-Counter-Measures}
    \acro{EA}{Electronic Attack}
    \acro{PDW}{Pulse Descriptor Word}
    ...
    \acro{ESA}{Electronically Steered Array}
    \acro{AESA}{Active Electronically Steered Array}
    ...
    \acro{MIMO}{Multiple-Input and Multiple-Output}
    \acro{POMDP}{Partially Observable Markov Decision Processes}
    \acro{MDP}{Markov Decision Process}
    \acro{FMP}{Frequency Modulated Pulse}
