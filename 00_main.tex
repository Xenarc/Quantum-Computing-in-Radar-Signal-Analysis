...
% \usepackage[utf8]{inputenc}
\usepackage{geometry}
\geometry{a4paper, inner=50mm, outer=20mm, left=48mm,  top=22mm, bottom=22mm, right=22mm, marginwidth=40mm} %, showframe}
\usepackage{setspace}
...
\begin{titlepage}
    ...
    \begin{large}   
        ...
        {\bf Submitted as Research Report / Honours / Master Dissertation in SIT723}
       \vspace{1cm}
